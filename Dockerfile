...
RUN echo '    Header always set Content-Security-Policy "default-src '\''self'\''; script-src '\''self'\'' '\''nonce-MiN0nc3F1j0-2024-Q9x7p8T'\'' https://www.googletagmanager.com https://code.jquery.com https://unpkg.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net; style-src '\''self'\'' https://cdnjs.cloudflare.com https://fonts.googleapis.com https://unpkg.com '\''unsafe-inline'\''; font-src '\''self'\'' https://fonts.gstatic.com; img-src '\''self'\'' data: https:; connect-src '\''self'\'' https://www.google-analytics.com;"' >> /etc/apache2/conf-available/security-headers.conf
